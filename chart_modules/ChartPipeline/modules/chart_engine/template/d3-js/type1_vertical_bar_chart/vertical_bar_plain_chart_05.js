...
REQUIREMENTS_BEGIN
{
    ...
    "chart_name": "vertical_bar_plain_chart_05",
    "required_fields": ["x", "y"],
...
// 使用D3.js创建简单的垂直条形图   plain chart#5 曲线形
function makeChart(containerSelector, data) {
    ...
    chart.selectAll(".bar")
        ...
        .attr("class", "bar")
        .attr("d", d => {
            const x_start = xScale(d.x);
            const y_top = yScale(d.y);
            ...
            const sigma = half / 3.2; // 让 ±3σ ≈ half，曲线边缘落在条形图边界内
