...
function makeChart(containerSelector, data) {
    ...
    for (let row = 0; row < rows; row++) {
        ...
        for (let colIdx = 0; colIdx < itemsInThisRow; colIdx++) {
            ...
            // ---------- 10. 绘制正方形 ----------
            // (radius * 2) is the max side length possible in the cell's reserved space for a shape
            ...
            if (proportionalSide > 0 && proportionalSide < 10) { // Min side 10
                displaySide = 10;
            }

            if (displaySide > 0) { // Only draw if side is positive
            ...
            chartGroup.append("text") // Dimension Label
                .attr("x", 0)
                .attr("y", -radius - 10) // Positioned above the shape's max possible extent
            ...
            // Fit text inside square if possible, and square is not too small
            const canFitInside = displaySide >= 10 && // Ensure square is at least min size
                                 labelBBox.width < displaySide * 0.85 && 
                                 labelBBox.height < displaySide * 0.85;
            ...
            if (canFitInside) {
                ...
                valueLabel
                    .attr("x", 0)
                    .attr("y", (displaySide / 2) + 3) // Position below the square
                    .attr("text-anchor", "middle")
