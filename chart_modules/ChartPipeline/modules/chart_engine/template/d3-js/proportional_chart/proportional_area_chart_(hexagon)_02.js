        ...
        for (let colIdx = 0; colIdx < itemsInThisRow; colIdx++) {
            ...
            if (displayRadius > 0) { // 仅当半径为正时绘制
                ...
                if (iconUrl) {
                    ...
                    // 计算图标显示大小，大一些以确保填满六边形
                    const boxSize = displayRadius * 2.3; // 大于六边形的外接圆直径
                    ...
                    chartGroup.append("path")
                        ...
                        .attr("stroke-width", variables.has_stroke ? 1 : 0)
                        .style("filter", variables.has_shadow ? "url(#shadow)" : "none")
                        .style("opacity", 0.85); // 保留原彩色六边形的透明度
                }
            }
            ...
            chartGroup.append("text") // 数值标签
                .attr("x", 0)
                .attr("y", displayRadius + 5) // 紧贴六边形下方
                .attr("text-anchor", "middle")
