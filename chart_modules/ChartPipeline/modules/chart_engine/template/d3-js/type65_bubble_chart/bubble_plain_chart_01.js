...
function makeChart(containerSelector, data) {
        ...
        for (const pos of positions) {
            ...
            for (const p of allPoints) {
                ...
                if (pPos) {
                    ...
                    if (pPos.priority === 1) {
                        otherLabelX1 = pX + 20; otherLabelY1 = pY - otherLabelHeight/2;
                    } else if (pPos.priority === 2) {
                        otherLabelX1 = pX - otherLabelWidth / 2; otherLabelY1 = pY - 20 - otherLabelHeight;
                    } else if (pPos.priority === 3) {
                        otherLabelX1 = pX - 20 - otherLabelWidth; otherLabelY1 = pY - otherLabelHeight/2;
                    } else if (pPos.priority === 4) {
                        otherLabelX1 = pX - otherLabelWidth / 2; otherLabelY1 = pY + 20;
                    } else if (pPos.priority === 5) {
                        otherLabelX1 = pX + 15; otherLabelY1 = pY - 15 - otherLabelHeight;
                    } else if (pPos.priority === 6) {
                        otherLabelX1 = pX - 15 - otherLabelWidth; otherLabelY1 = pY - 15 - otherLabelHeight;
                    } else if (pPos.priority === 7) {
                        otherLabelX1 = pX - 15 - otherLabelWidth; otherLabelY1 = pY + 15;
                    } else {
                        otherLabelX1 = pX + 15; otherLabelY1 = pY + 15;
                    }
    ...
    points.append("circle")
        ...
        .attr("fill", d => {
            // 获取圆形颜色 - 从colors.field中获取，如果不存在则使用默认主色
            let circleColor = colors.other.primary;
            if (colors.field && colors.field[d[xField]]) {
                circleColor = colors.field[d[xField]];
            }
            return circleColor;
        });
