...
function makeChart(containerSelector, data) {
    ...
    variables.has_rounded_corners = 1
    ...
    categorySquares.forEach(cat => {
        ...
        for (let i = 0; i < cat.squares; i++) {
            ...
            chart.append("rect")
                ...
                .attr("fill", cat.color)
                .attr("rx", variables.has_rounded_corners ? Math.max(1, squareSize * 0.1) : 0)
                .attr("ry", variables.has_rounded_corners ? Math.max(1, squareSize * 0.1) : 0)
                .attr("stroke", variables.has_stroke ? "#555" : "none")
                .attr("stroke-width", variables.has_stroke ? Math.max(0.5, squareSize * 0.05) : 0)
